export default function UserDocument() {
  return (
    <div className="mx-auto max-w-md p-5 text-center md:p-10">
      <h1 className="mb-2 font-serif text-xl font-semibold text-madRed md:text-3xl">
      ...
      <h2 className="mb-6 font-serif text-lg font-semibold text-madRed md:text-2xl">
        🎭 À vos marques, prêt·e·s, créez !
      </h2>

      <p className="mb-8 text-lg text-gray-800 italic">
      ...
      <div className="mb-6 flex justify-center gap-3">
        <div className="h-4 w-4 animate-pulse rounded-full bg-madEncart"></div>
        <div className="h-4 w-4 animate-pulse rounded-full bg-madEncart [animation-delay:0.3s]"></div>
        <div className="h-4 w-4 animate-pulse rounded-full bg-madEncart [animation-delay:0.6s]"></div>
      </div>
      ...
      <div className="mt-6 text-gray-700">
        ...
        <a
          href="/Contact"
          className="cursor-pointer font-medium text-madRed hover:underline"
        >
